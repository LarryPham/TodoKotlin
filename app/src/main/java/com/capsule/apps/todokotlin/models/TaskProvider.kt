...
class TaskProvider : ContentProvider() {
    ...
    override fun query(uri: Uri?, projection: Array<out String>?, selection: String?, selectionArgs: Array<out String>?, sortOrder: String?): Cursor? {
        ...
        when (match) {
            ...
            TASK_WITH_ID -> {
                ...
                cursor = db.query(TaskContract.TaskEntry.TABLE_NAME, projection, "${TaskContract.TaskEntry._ID} = ?",
                        arrayOf(id.toString()), null, null, sortOrder)
            }
    ...
    override fun delete(uri: Uri?, selection: String?, selectionArgs: Array<out String>?): Int {
        ...
        when (match) {
            ...
            else -> throw UnsupportedOperationException("Unknow uri: $uri")
        }
